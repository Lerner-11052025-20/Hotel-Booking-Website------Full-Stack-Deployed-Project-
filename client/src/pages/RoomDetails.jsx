...
import { roomCommonData } from '../assets/assets' // ← if it’s exported there
...
const RoomDetails = () => {
    ...
    return room && (
        <div className=' py-28 md:py-35 px-4 md:px-16 lg:px-16 xl:px-32'>
            ...
            {/**room rating */}
            <div className='flex flex-center gap-1 mt-2'>
            ...
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
                ...
                <div className='grid grid-cols-2 grid-rows-2 gap-4 lg:w-1/2 w-full'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type='date' id='checkOurDate' placeholder='Check-Out' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none ' required />
                    </div>
                    <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                    {/* Guests */}
                    <div className='flex flex-col'>
                ...
                {roomCommonData.map((spec, index) => (
                    <div key={index} className='flex items-start gap-2'>
                        <img
                            src={spec.icon}
                            alt={`${spec.title}-icon`}
                            className='w-[26px]' // precise custom width
                        />
                        <div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-50e'>
